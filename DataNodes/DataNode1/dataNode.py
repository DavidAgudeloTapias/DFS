...
class DataNodeService(DataNodeServiceServicer):
    def __init__(self, storage_path, other_data_nodes):
        self.address = f'44.223.170.156:{data_node_port}'
        self.blocks = {}
...
def serve(storage_path, port, other_data_nodes):
    ...
    server.add_insecure_port(f'44.223.170.156:{port}')
...
if __name__ == '__main__':
    ...
    other_nodes = ["18.213.214.147:50051", "44.205.61.12:50052"]  # List of other DataNodes to replicate to
