...
class DataNodeService(DataNodeServiceServicer):
    def __init__(self, storage_path, other_data_nodes):
        self.address = f'172.31.88.105:{data_node_port}'
        self.blocks = {}
...
def serve(storage_path, port, other_data_nodes):
    ...
    server.add_insecure_port(f'172.31.88.105:{port}')
...
if __name__ == '__main__':
    ...
    other_nodes = ["172.31.84.218:50051", "172.31.94.91:50052"]  # List of other DataNodes to replicate to
