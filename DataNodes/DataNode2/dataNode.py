...
class DataNodeService(DataNodeServiceServicer):
    def __init__(self, storage_path, other_data_nodes):
        self.address = f'18.213.214.147:{data_node_port}'
        self.blocks = {}
...
def serve(storage_path, port, other_data_nodes):
    ...
    server.add_insecure_port(f'18.213.214.147:{port}')
...
if __name__ == '__main__':
    ...
    data_node_port = os.getenv('DATA_NODE_PORT', 50051)
    other_nodes = ["44.223.170.156:50050", "44.205.61.12:50052"]  # List of other DataNodes to replicate to
